...
from utils import IdAdminUserMixin
...
class BucketHome(View, IdAdminUserMixin):
...
class DeleteBucketObjectView(View, IdAdminUserMixin):
...
class DownloadBucketObjectView(View, IdAdminUserMixin):
